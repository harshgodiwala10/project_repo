...
class CSVProcessorApp:
    ...
    def create_results_page(self):
        ...
        self.btn_processed = ctk.CTkButton(self.nav_frame,
                                           text="classification",
                                           command=lambda: self.show_table(self.df_processed, "classifiaction"),
                                           width=200,
                                           font=self.font_normal,
                                           state="disabled")
        ...
        self.btn_processed = ctk.CTkButton(self.nav_frame,
                                           text="Regression",
                                           command=lambda: self.show_table(self.df_processed, "regression"),
                                           width=200,
                                           font=self.font_normal,
                                           state="disabled")
        self.btn_processed.pack(side="left", padx=10)
        self.btn_processed = ctk.CTkButton(self.nav_frame,
                                           text="Visualization",
                                           command=lambda: self.show_table(self.df_processed, "visualization"),
                                           width=200,
                                           font=self.font_normal,
                                           state="disabled")
        self.btn_processed.pack(side="left", padx=10)
